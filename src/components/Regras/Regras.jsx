...
export default function Regras({ setScrollLocked }) {
  ...
  const regras = [
    ...
    { id: 2, texto: <><span className="bold-text">Não usar cores:</span> lilás, roxo e dourado;</> },
    ...
    { id: 5, texto: <>Use a hashtag <span className="bold-text">#NicFaz15</span> ao postar uma foto na nossa festa.</> },
  ];
